  ...
  return createPortal(
    <div className="fixed top-0 left-0 w-full h-screen bg-black-30 backdrop-blur-sm z-50 transition-all">
      ...
      >
        <button
          onClick={close}
          className="bg-none border-0 p-2 rounded-sm translate-x-3 transition-all absolute top-5 right-8 hover:bg-gray-100"
        >
          <HiXMark className="w-10 h-10 text-gray-700 hover:border hover:border-indigo-600" />
        </button>
